package com.technobit.repair_timer.ui.customize.signatureview;
...
import com.technobit.repair_timer.ui.customize.signatureview.model.Point;
...
public class SignatureView extends View{
    ...
    public boolean isBitmapEmpty() {
        if (bmp != null) {
            ...
            canvasBmp.drawColor(backgroundColor);
            return bmp.sameAs(emptyBitmap); // true if same, false otherwise
        }
        return false;
    }
